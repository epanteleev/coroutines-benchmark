...
run_kotlin0 kotlin/bench0 bench0 1000                                          
run_kotlin0 kotlin/bench0 bench0 10000                                          
run_kotlin0 kotlin/bench0 bench0 100000                                          
run_kotlin0 kotlin/bench0 bench0 1000000                                          
...
build_kotlin kotlin/bench1

echo -e "$GREEN ...RUN KOTLIN... $RESET"

for ((i=10; i <= 1000000; i=i*10)) do 
  run_kotlin0 kotlin/bench1 bench1 "$i tmp/outKotlin.txt"
done
